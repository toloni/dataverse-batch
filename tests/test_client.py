...
class TestDataverseClient:
    ...
    @responses.activate
    def test_successful_authentication(self, sample_config, mock_authentication_response):
        ...
        responses.add(
            responses.POST,
            auth_url,
            json=mock_authentication_response,
            status=200
        )
    ...
    def test_create_batch_payload(self, sample_config, sample_account_data):
        ...
        with patch('dataverse_batch.client.DataverseClient._authenticate'):
            ...
            payload, headers = client._create_batch_payload('accounts', sample_account_data[:2])
            ...
            assert 'POST https://test.crm.dynamics.com/api/data/v9.2/accounts HTTP/1.1' in payload
    ...
    @responses.activate
    def test_create_records_batch_success(self, sample_config, sample_account_data, sample_batch_response_success):
        ...
        with patch('dataverse_batch.client.DataverseClient._authenticate'):
            ...
            responses.add(
                responses.POST,
                batch_url,
                body=sample_batch_response_success,
                status=200
            )
    ...
    @responses.activate
    def test_create_records_batch_with_errors(self, sample_config, sample_account_data, sample_batch_response_with_errors):
        ...
        with patch('dataverse_batch.client.DataverseClient._authenticate'):
            ...
            responses.add(
                responses.POST,
                batch_url,
                body=sample_batch_response_with_errors,
                status=200
            )
...
--batch_response--"""
            ...
            results = client._parse_batch_response(mock_response, sample_account_data[:3])
